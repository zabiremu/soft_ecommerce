...
class DeliveryManController extends Controller
{
    ...
    public function update_order_status(Request $request)
    {
        ...
        if ($request['status'] == 'out_for_delivery') {
            Helpers::send_order_notification('out_for_delivery','customer',$order);
        } elseif ($request['status'] == 'delivered') {
            Helpers::send_order_notification('delivered','customer',$order);
        }
    ...
    public function update_expected_delivery(Request $request){
        ...
        Helpers::send_order_notification('order_rescheduled_message','delivery_man',$order);
