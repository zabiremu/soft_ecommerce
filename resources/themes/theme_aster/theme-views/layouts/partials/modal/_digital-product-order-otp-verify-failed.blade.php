<div class="d-flex justify-content-center">
    <a href="javascript:">
        <img src="{{theme_asset("assets/img/media/OTP-Verification-fail.png")}}" alt="logo" class="img-fluid" width="220">
    </a>
</div>
...
<div class="d-flex flex-column justify-content-center align-items-center gap-3 mt-5">
    ...
    <button type="button" class="btn btn-primary w-auto min-w-180" data-bs-toggle="modal" data-bs-target="#loginModal">{{translate('Open_Support_Ticket')}}</button>
</div>
