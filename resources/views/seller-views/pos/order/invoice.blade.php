...
<div style="width:363px;">
    ...
    <div class="row mt-3">
        <div class="col-6">
            <h5>{{ucfirst('order ID')}} : {{$order['id']}} {{ ($order->order_type == 'POS' ? '(POS Order)' : '' ) }}</h5>
        </div>
        <div class="col-6">
            ...
            @if($detail->product)
                ...
                <tr>
                    ...
                    <td class="text-left">
                        ...
                        {{ucfirst('discount')}} : {{\App\CPU\Helpers::currency_converter(round($detail['discount'],2))}}
                    </td>
    ...
    <table style="color: black!important; width: 100%!important">
        ...
        <tr>
            <td colspan="2"></td>
            <td class="text-right" style="font-size: 20px">{{ucfirst('total')}}:</td>
