<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/transaction/refund-transaction-list') ?'active':'' }}"><a href="{{ route('admin.transaction.refund-transaction-list') }}">{{translate('refund_Transactions')}}</a></li>
    </ul>
</div>
