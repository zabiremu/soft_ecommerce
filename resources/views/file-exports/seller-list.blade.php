<html>
    <table>
        <thead>
            <tr>
                <th style="font-size: 18px">{{translate('seller_List')}}</th>
            </tr>
            <tr>

                <th>{{ translate('seller_Analytics') }} -</th>
                <th></th>
                <th>
                        {{translate('total_Seller')}} - {{count($data['sellers'])}}
                    <br>
                        {{translate('active_Sellers ')}} - {{$data['active']}}
                    <br>
                        {{translate('inactive_Sellers ')}} - {{$data['inactive']}}
                </th>
            </tr>
            <tr>
